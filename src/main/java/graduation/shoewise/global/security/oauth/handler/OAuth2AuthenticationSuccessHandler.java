...
//        login 성공한 사용자 목록.
    ...
    protected String determineTargetUrl(HttpServletRequest request, HttpServletResponse response,
        ...
        // JWT 생성
        UserTokenDto.TokenInfo tokenInfo = jwtTokenProvider.generateToken(authentication);
        log.info("OAuth2 SuccessHandler - determineTargetUrl: " + tokenInfo.getAccessToken());
